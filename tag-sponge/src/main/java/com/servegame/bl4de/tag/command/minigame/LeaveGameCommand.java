...
/**
 * File: LeaveGameCommand.java
 *
 * @author Brandon Bires-Navel (brandonnavel@outlook.com)
 */
public class LeaveGameCommand extends AbstractRunnableCommand<CommandSource> {

    public LeaveGameCommand(CommandSource src, CommandContext args, TagPlugin plugin) {
